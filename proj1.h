...
struct lista {    // DEFINIÇÃO DA STRUCT DA LISTA DE TAREFAS
  int prioridade; // VARIÁVEL QUE VAI ARMAZENAR A PRIORIDADE DA TAREFA (NÚMERO
                  // INTEIRO).
  char categoria[300]; //  ARRAY DE CARACTERES QUE VAI ARMAZENAR A CATEGORIA DA
                       //  TAREFA
  char descricao[100]; // ARRAY DE CARACTERES QUE VAI ARMAZENAR A DESCRIÇÃO DA
                       // TAREFA
